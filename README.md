...
Repka — AI-native планировщик с диаграммой Ганта: загрузка задач из Excel, визуализация на таймлайне и изменение плана через чат с LLM (OpenRouter / `openai/gpt-4o-mini` по умолчанию) и MCP-инструментами.
