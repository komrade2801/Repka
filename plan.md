...
- [x] Импорт с построчной валидацией: форматы данных, неизвестный `priority`, `predecessors`, дубликаты названий; при любых замечаниях — toast с деталями, импорт не выполняется.
