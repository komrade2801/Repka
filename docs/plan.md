...
- [x] Демо-видео: [YouTube](https://youtu.be/wllOO0AkVI4) (Excel → чат → Гантт → экспорт); ссылка в README.
...
- [x] В репо: README (архитектура + AI-ассистенты) + Roadmap + sample Excel + ссылки на git и deployed app + [демо-видео](https://youtu.be/wllOO0AkVI4).
...
| 10 | **почти** — Render + Vercel задеплоены; README / Roadmap / docs / [демо-видео](https://youtu.be/wllOO0AkVI4) обновлены; остаётся финальная ручная приёмка |
